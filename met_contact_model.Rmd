...
The districts with the highest risk of infection are located in Hanoi and Ho Chi Minh provinces. There are a few districts with very low population densities that have relatively high risks of infection, which are presumably attributable to the fact that they are isolated and do not travel outside the population. 
...
Generally, risk of infection increases with population density. We see, however, that some populations with low density have high risks of infection. 
